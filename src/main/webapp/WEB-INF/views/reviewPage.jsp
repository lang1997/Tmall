...
<style>
    ...
    span.reviewProductInfoRightBelowImg {
        ...
        width: 23px;
        height: 42px;
        background-image: url(<%=request.getContextPath()%>/img/fore/reviewLight.png);
...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg"></div>
        <div class="reviewProductInfoRightDiv">
            ...
            <div class="reviewProductInfoRightBelowDiv">
                <span class="reviewProductInfoRightBelowImg"><img src="<%=request.getContextPath()%>/img/fore/reviewLight.png"></span>
