...
<style>
    ...
    span.wangwangGif {
        ...
        width: 25px;
        height: 25px;
        background-image: url(<%=request.getContextPath()%>/img/fore/wangwang.gif);
...
<div class="buyPageDiv">
    <form action="createOrder" method="post">
        ...
        <div class="buyFlow">
            <img class="pull-left" src="<%=request.getContextPath()%>/img/fore/simpleLogo.png">
            <img class="pull-right" src="<%=request.getContextPath()%>/img/fore/buyflow.png">
        ...
        <div class="productList">
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        <img class="tmallbuy" src="<%=request.getContextPath()%>/img/fore/tmallbuy.png">
                ...
                <c:forEach items="${orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="<%=request.getContextPath()%>/img/product/${oi.product_id}/${oi.product_id}.jpg">
                        </td>
                        <td class="orderItemProductInfo">
                            <a href="<%=request.getContextPath()%>/foreproduct?pid=${oi.product_id}" class="orderItemProductLink">
                                    ${oi.product.name}
                            </a>

                            <img src="<%=request.getContextPath()%>/img/fore/creditcard.png" title="支持信用卡支付">
                            <img src="<%=request.getContextPath()%>/img/fore/7day.png" title="消费者保障服务,承诺7天退货">
                            <img src="<%=request.getContextPath()%>/img/fore/promise.png" title="消费者保障服务,承诺如实描述">
            ...
            <div class="orderItemSumDiv">
                <div class="pull-left">
                    ...
                    <span>
                        <img class="leaveMessageImg" src="<%=request.getContextPath()%>/img/fore/leaveMessage.png">
                    </span>
