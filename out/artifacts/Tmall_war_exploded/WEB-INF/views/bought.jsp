        ...
        <c:forEach items="${orders}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2"><img width="13px" src="<%=request.getContextPath()%>/img/fore/orderItemTmall.png">天猫商场</td>
                    <td colspan="1">
                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR">
                        <td class="orderItemProductInfoPartTD"><img width="80" height="80"
                                                                    src="<%=request.getContextPath()%>/img/product/${oi.product.id}/${oi.product.id}.jpg">
                        </td>
