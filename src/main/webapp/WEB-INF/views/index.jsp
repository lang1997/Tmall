        ...
        <div data-ride="carousel" class="carousel-of-product carousel" id="carousel-of-product">
            ...
            <div role="listbox" class="carousel-inner">
                <div class="item active">
                    <img src="<%=request.getContextPath()%>/img/fore/carousel1.jpg" class="carousel carouselImage">
                </div>
                <div class="item">
                    <img src="<%=request.getContextPath()%>/img/fore/carousel2.jpg" class="carouselImage">
                </div>
                <div class="item">
                    <img src="<%=request.getContextPath()%>/img/fore/carousel3.jpg" class="carouselImage">
                </div>
                <div class="item">
                    <img src="<%=request.getContextPath()%>/img/fore/carousel4.jpg" class="carouselImage">
                </div>
            </div>
        </div>
    </div>
...
<div class="new-floor-con">
    <div class="workArea">
                    ...
                    <div class="floor-line-con">
                        ...
                        <c:forEach items="${c.products}" var="p" varStatus="st">
                            <c:if test="${st.count<=5}">
                                <a class="grid" href="<%=request.getContextPath()%>/showProduct?product_id=${p.id}">
                                    <div class="productItem">
                                        <img class="floor-item-img" src="<%=request.getContextPath()%>/img/product/${p.id}/${p.id}.jpg">
        ...
        <div class="tm-end">
            <img src="<%=request.getContextPath()%>/img/fore/end.png"/>
        </div>
    </div>
</div>
<div style="clear: both;"></div>
