...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		String[] noNeedAuthPage = new String[]{
				...
				request.getContextPath()+"/searchProduct",
				request.getContextPath()+"/sortProduct",
				request.getContextPath()+"/showProduct",
				request.getContextPath()+"/loginPage",
				request.getContextPath()+"/login",
				request.getContextPath()+"/registerPage",
				request.getContextPath()+"/register",
				request.getContextPath()+"/registerSuccessPage",
				request.getContextPath()+"/test",
				request.getContextPath()+"/checkLogin",
