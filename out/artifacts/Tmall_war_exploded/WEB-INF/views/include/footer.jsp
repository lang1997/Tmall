...
<div id="footer" class="footer" style="display: block;">
    ...
    <div class="workArea">
        <div class="tmall-ensure">
            <a href="#nowhere">
                <img src="<%=request.getContextPath()%>/img/fore/footer1.png">
                <img src="<%=request.getContextPath()%>/img/fore/footer2.png">
                <img src="<%=request.getContextPath()%>/img/fore/footer3.png">
                <img src="<%=request.getContextPath()%>/img/fore/footer4.png">
            </a>
        </div>
        ...
        <div class="tmall-desc">
            ...
            <dl>
                ...
                <dd><a href="#nowhere"><img src="<%=request.getContextPath()%>/img/fore/qr-code.png"></a></dd>
            </dl>
        </div>
    ...
    <div class="workArea">
        <img src="<%=request.getContextPath()%>//img/fore/tmall-cat.png" class="tmall-cat">
    </div>
        ...
        <div class="workArea">
            <div class="mui-global-fragment-load">
                ...
                <div class="footer-copyright">
                    ...
                    <div>
                        <img src="<%=request.getContextPath()%>/img/fore/copyRight1.jpg">
                        <img src="<%=request.getContextPath()%>/img/fore/copyRight2.jpg">
                    </div>
                </div>
            </div>
