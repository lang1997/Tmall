            ...
            $.get(
                ...
                function (result) {
                    if ("success" == result) {
                        ...
                        var num = $(".productNumberSetting").val();
                        var addCartpage = "<%=request.getContextPath()%>/addCart";
                        $.get(
                            addCartpage,
...
<div class="product">
    <div class="imgAndInfo">
        <div class="imgInimgAndInfo">
            <img class="bigImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
            <div class="smallImageDiv">
                <img class="smallImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg" bigImgURL="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
                <img class="smallImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg" bigImgURL="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
                <img class="smallImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg" bigImgURL="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
                <img class="smallImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg" bigImgURL="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
                <img class="smallImg" src="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg" bigImgURL="<%=request.getContextPath()%>/img/product/${product.id}/${product.id}.jpg">
        ...
        <div class="infoInimgAndInfo">
            ...
            <div class="productPrice">
                <div class="productPriceDiv">
                    <div class="gouwujuanDiv"><img src="<%=request.getContextPath()%>/img/fore/tmall-coupon.png">
                        <span> 全天猫实物商品通用</span>
                    </div>
            ...
            <div class="productNumber">
                ...
                <input type="text" id="number" value="1" class="productNumberSetting">
                    ...
                    <span class="updown">
                       <img src="<%=request.getContextPath()%>/img/fore/increase.png">
                    </span>
					</a>
					<span class="updownMiddle"> </span>
					<a class="decreaseNumber" href="#nowhere">
						<span class="updown">
                        <img src="<%=request.getContextPath()%>/img/fore/decrease.png">
                    </span>
					</a>
					</span>
					件</span>
            ...
            <script>
                ...
                function buyLink() {
                    window.location.href="<%=request.getContextPath()%>/buyone?product_id="+${product.id}+"&number=" + $("#number").val();
                }
            </script>
            <div class="buyDiv">
...
<div class="productDetailDiv" style="display: block;">
    ...
    <div class="productDetailImagesPart">
        <img src="<%=request.getContextPath()%>/img/8626.jpg">
    </div>
</div>
<div style="clear:both"></div>
