...
<div class="header">
    <div class="headerLayout workArea">
        ...
        <div class="logo">
            <a href="${context}">
                <img src="<%=request.getContextPath()%>/img/fore/tmall-logo.png">
            </a>
        </div>
...
<div class="main-nav">
    <div class="workArea">
        ...
        <span>
            <a href="">
                <img src="<%=request.getContextPath()%>/img/fore/tmall-shop.png">
            </a>
            <a href="">
                <img src="<%=request.getContextPath()%>/img/fore/tmall-international.png">
            </a>
